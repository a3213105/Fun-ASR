...
@tables.register("model_classes", "FunASRNanoOV")
class FunASRNanoOV(nn.Module):
    def __init__(
        self,
        model_path: str,
        enc_type: str = "bf16",
        ...
        **kwargs,
        ...
        super().__init__()
        self.ov_model = FunAsrNanoEncDecModel(ov_core=None, model_path=model_path, enc_type=enc_type, dec_type=dec_type, cache_size=cache_size, disable_ctc=disable_ctc)
        self._cpu_anchor = nn.Parameter(torch.tensor(1.0, dtype=torch.float32, device="cpu"), requires_grad=False)
    ...
    def inference(
        ...
        **kwargs,
        ...
        return self.ov_model.inference(data_in, data_lengths, key, tokenizer, frontend, **kwargs)
